...
subroutine fget_grids(x0, x1, nx, xs)
...
subroutine fget_eij_morse(rij, param, eij)
...
subroutine fget_total_eij_morse(nm, nb, nbt, x, y, param, dys)
...
subroutine fget_ediff_morse(nm, nb, nbt, x, y, param, mae, rmse)
...
subroutine fscan_pramas_morse(nm, nb, nbt, x, y, npts, ranges, cs)
    ...
    a0 = ranges(1,1) !1.0
    a1 = ranges(2,1) !300.0
    call fget_grids(a0,a1,npts(1),xsa) 
    b0 = ranges(1,2) !1.0
    b1 = ranges(2,2) !300.0
    call fget_grids(b0,b1,npts(2),xsb) 
    ...
    if ( npts(3) .eq. 1 ) then
        ...
        c0 = ranges(1,3) !1.0
        c1 = ranges(2,3) !300.0
        call fget_grids(c0,c1,npts(3),xsc) 
    endif
            ...
            do ib1 = 1, npts(2)
                do ia2 = 1, npts(1)
                    do ib2 = 1, npts(2)
                        ...
                        call fget_ediff_morse(nm, nb, nbt, x, y, param, mae, rmse)
