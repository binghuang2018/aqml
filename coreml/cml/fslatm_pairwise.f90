...
subroutine calc_sbot(na, coords, zs, z1, z2, z3, rscut, nx, dgrid, sigma, rpower3, ys)
    !use fslatm_math
...
subroutine calc_sbot_local(na,coords,zs,ia,ib,z1,z2,z3,rscut,nx,dgrid,sigma,w3,rpower3, ys)
    !use fslatm_math
    implicit none
    integer, intent(in) :: na
    double precision, dimension(3,na), intent(in) :: coords
...
subroutine calc_sbop(na, coords, zs, z1, z2, rscut, nx, dgrid, sigma, rpower2, ys)
    !use fslatm_math
    implicit none
    integer, intent(in) :: na
    double precision, dimension(3,na), intent(in) :: coords
...
subroutine calc_sbop_local(coords, zs, ia, ib, z1, z2, rscut, nx, dgrid, sigma, w2,rpower2, ys)
    !use fslatm_math
    implicit none
...
subroutine calc_spectrum(na0,zs,coords,n1,n2,n3,mbs1,mbs2,mbs3, &
    ...
    do imb2 = 1,n2
        ...
        jb = n1 + (imb2-1)*nsx(1)
        je = n1 + imb2*nsx(1)
        call calc_sbop(na0,coords,zs,z1,z2,rscut,nsx(1),dgrid,sigma,rpower2,ys(jb:je))
    enddo
    do imb3 = 1,n3
        z1 = mbs3(1,imb3)
        z2 = mbs3(2,imb3)
        ...
        call calc_sbot(na0,coords,zs,z1,z2,z3,rscut,nsx(3),dgrid,sigma,rpower3,ys(jb:je))
    enddo
end subroutine
...
subroutine calc_local_spectrum(na0,zs,coords,nbmax,nbrs,n,nu,n1,n2,n3,mbs1,mbs2,mbs3, &
    ...
    do i = 1,na1
        ...
        do imb2 = 1,n2
            ...
            call calc_sbop_local(coords,zs,ia,0,z1,z2,rscut,nsx(1),dgrid,sigma,w2,rpower2,ys(ibgn:iend,ia))
        ...
        do imb3 = 1,n3
            ...
            call calc_sbot_local(na0,coords,zs,ia,0,z1,z2,z3,rscut,nsx(3),dgrid,sigma,w3,rpower3,ys(ibgn:iend,ia))
            !call check_nan2(n,na0,ys)
        enddo
    enddo
    !print *, '#####2'
        ...
        do i = 1,na1
            ...
            do j = 1,nas2(i)
                ...
                do imb2 = 1,n2
                    ...
                    call calc_sbop_local(coords,zs,ia,ja,z1,z2,rscut,nsx(2),dgrid,sigma,w2,rpower2,ys2(ibgn:iend,j,ia))
                ...
                do imb3 = 1,n3
                    ...
                    call calc_sbot_local(na0,coords,zs,ia,ja,z1,z2,z3,rscut,nsx(3),dgrid,sigma,w3,rpower3,ys2(ibgn:iend,j,ia))
                    !print *, ' DONE!'
                    !call check_nan3(n,nbmax,na0,ys2)
                enddo
            enddo
...
subroutine calc_all_local_spectrum(nm,na,nas,zs,coords,nbmax,nbrs, &
    ...
    do i = 1,nm
        ib = ias1(i)
        ie = ias2(i)
        call calc_local_spectrum(nas(i),zs(ib:ie),coords(:,ib:ie), &
...
subroutine calc_local_dij(na1,na2,n,x1,x2,dsij)
    implicit none
...
subroutine calc_local_kij(na1,na2,n,x1,x2,nco,kwds,kijs)
    implicit none
...
subroutine calc_kij(n,x1,x2,nco,kwds,kijs)
    implicit none
...
subroutine calc_mk1(local,nm,na,nas,zs,coords,nbmax,nbrs,n1,n2,n3,mbs1,mbs2,mbs3,&
    ...
    if (local) then
        ...
        do i = 1,nm
            do j = i,nm
                !print *, ' I,J = ', I,J
                call calc_local_spectrum(nas(i),zs(ias1(i):ias2(i)),coords(:,ias1(i):ias2(i)), &
                ...
                call calc_local_spectrum(nas(j),zs(ias1(j):ias2(j)),coords(:,ias1(j):ias2(j)), &
                                  nbmax,nbrs(:,ias1(i):ias2(i)), n,nu,n1,n2,n3,mbs1,mbs2,mbs3, nsx, &
                                  rscut,dgrid,sigma,w2,rpower2,w3,rpower3, 0, -1, xs2(:,1:nas(j)), nul(:,:,1:nas(i)))
                call calc_local_kij(nas(i),nas(j),n,xs1(:,1:nas(i)),xs2(:,1:nas(j)), nco,kwds, kijs)
                k1(:,i,j) = kijs
                k1(:,j,i) = kijs
            enddo
        enddo
        ...
        do i = 1,nm
            do j = i,nm
                call calc_spectrum(nas(i),zs(ias1(i):ias2(i)),coords(:,ias1(i):ias2(i)), n1,n2,n3,&
                                  mbs1,mbs2,mbs3, n,nsx,rscut,dgrid,sigma,rpower2,rpower3,x1)
                call calc_spectrum(nas(j),zs(ias1(j):ias2(j)),coords(:,ias1(j):ias2(j)), n1,n2,n3, &
                                  mbs1,mbs2,mbs3, n,nsx,rscut,dgrid,sigma,rpower2,rpower3,x2)
                call calc_kij(n,x1,x2, nco,kwds, kijs)
                k1(:,i,j) = kijs
                k1(:,j,i) = kijs
            enddo
        enddo
...
subroutine calc_mk2(local,nm1,nm,na,nas,zs,coords,nbmax,nbrs,n1,n2,n3,mbs1,mbs2,mbs3,&
    ...
    if (local) then
        ...
        do i = 1,nm1
            do j = nm1+1,nm
                call calc_spectrum(nas(i),zs(ias1(i):ias2(i)),coords(:,ias1(i):ias2(i)), &
                            n1,n2,n3,mbs1,mbs2,mbs3, n,nsx,rscut,dgrid,sigma,rpower2,rpower3,x1)
                call calc_spectrum(nas(j),zs(ias1(j):ias2(j)),coords(:,ias1(j):ias2(j)), &
...
subroutine calc_dij_max(local,nm,na,nas,zs,coords,nbmax,nbrs,n1,n2,n3,mbs1,mbs2,mbs3,&
        ...
        do i = 1,nm
            do j = i,nm
                ...
                call calc_local_spectrum(nas(j),zs(ias1(j):ias2(j)),coords(:,ias1(j):ias2(j)), &
                                  nbmax,nbrs(:,ias1(i):ias2(i)), n,nu,n1,n2,n3,mbs1,mbs2,mbs3, nsx, &
                                  rscut,dgrid,sigma,w2,rpower2,w3,rpower3, 0, -1, xs2(:,1:nas(j)), nul(:,:,1:nas(i)))
                call calc_local_dij(nas(i),nas(j),n,xs1(:,1:nas(i)),xs2(:,1:nas(j)), dsij(1:nas(i),1:nas(j)))
                ds(i,j) = maxval(dsij)
            enddo
        enddo
        !$OMP end parallel do
